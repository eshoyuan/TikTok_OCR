...
if os.path.exists("data/PSOL_imgs")==False:
    os.mkdir("data/PSOL_imgs")
def func1():
    for i in tqdm(file_lists[:40000]):
        if os.path.exists("data/PSOL_imgs/train1")==False:
            os.mkdir("data/PSOL_imgs/train1")
        shutil.copyfile("data/train_crop_low/"+i,"data/PSOL_imgs/train1/"+i)
    print("Done1")
def func2():
    for i in tqdm(file_lists[40000:]):
        if os.path.exists("data/PSOL_imgs/train2")==False:
            os.mkdir("data/PSOL_imgs/train2")
